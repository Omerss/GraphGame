...
def save_game_data (location, user_id, game_round):
    """
    ...
    #raise exception
    error = save_game_graphs (directory, user_id, game_round, real_graph, user_graph)

    #raise exception
    error = save_game_metadata(location, user_id, game_round, answers_object_list, node_seen_percentage, user_answers_percentage, user_graph_answer_percentage, button_press_list, button_func_list)
...
def save_game_metadata(location, user_id, game_round, answers_object_list, node_seen_percentage, user_answers_percentage, user_graph_answer_percentage, button_press_list, button_func_list):
    ...
    the_json_data = create_dict_for_game_metadata(dict_answers_object_list, node_seen_percentage, user_answers_percentage, user_graph_answer_percentage, button_press_list, button_func_list)
