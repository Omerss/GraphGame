...
class QuestionnaireScreen(Screen):
    ...
    def setup(self, main_app, number=-1, real_user=True, question_list=None):
        """
        ...
        self.main_app.question_list = question_list if question_list is not None else self.create_questions()
