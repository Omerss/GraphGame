...
def create_draft_graph_2():
    ...
    draft_graph = GraphObject(max_x=1050, max_y=1800, node_count=15 , max_neighbors=max_neighbors,
                              extra_distance=extra_distance)
    draft_graph.add_node(x_loc=1004, y_loc=1721, node_colour=Colours['yellow'], serial="n1")
    draft_graph.add_node(x_loc=1021, y_loc=1607, node_colour=Colours['yellow'], serial="n2")
    draft_graph.add_node(x_loc=703, y_loc=1607, node_colour=Colours['blue'], serial="n3")
    draft_graph.add_node(x_loc=653, y_loc=1302, node_colour=Colours['blue'], serial="n4")
    draft_graph.add_node(x_loc=522, y_loc=1306, node_colour=Colours['red'], serial="n5")
    draft_graph.add_node(x_loc=303, y_loc=1006, node_colour=Colours['red'], serial="n6")
    draft_graph.add_node(x_loc=233, y_loc=1107, node_colour=Colours['yellow'], serial="n7")
    draft_graph.add_node(x_loc=373, y_loc=802, node_colour=Colours['blue'], serial="n8")
    draft_graph.add_node(x_loc=244, y_loc=659, node_colour=Colours['red'], serial="n9")
    draft_graph.add_node(x_loc=431, y_loc=1003, node_colour=Colours['blue'], serial="n10")
    draft_graph.add_node(x_loc=43, y_loc=803, node_colour=Colours['blue'], serial="n11")
    draft_graph.add_node(x_loc=154, y_loc=606, node_colour=Colours['red'], serial="n12")
